...
namespace AccountService.Infrastructure.Migrations.UserServiceDb
{
    ...
    [Migration("20240126220703_CreateUserServiceDB")]
    partial class CreateUserServiceDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountService.Domain.Entity.Department", b =>
                {
                    b.Property<byte[]>("Id")
            ...
            modelBuilder.Entity("AccountService.Domain.Entity.User", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("varbinary(16)")
                        .HasAnnotation("Key", true);
            ...
            modelBuilder.Entity("DepartmentUser", b =>
                {
                    b.HasOne("AccountService.Domain.Entity.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AccountService.Domain.Entity.User", null)
                        .WithMany()
